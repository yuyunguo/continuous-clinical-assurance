...
%\documentclass[apajournal,article,submit,moreauthors,unicode]{Definitions/mdpi} % For some letters Palatino lacks
%\documentclass[preprintsapa,article,submit,moreauthors]{Definitions/mdpi} 
%\documentclass[preprintsapa,article,submit,moreauthors,unicode]{Definitions/mdpi} 

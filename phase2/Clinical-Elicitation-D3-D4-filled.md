...
1. One class-2 error is about as bad as **5** class-1 errors?
   Best guess: ______  Plausible range: ______ to ______
2. One class-3 error is about as bad as **10** class-2 errors?
   Best guess: ______  Plausible range: ______ to ______
3. Missed deterioration against unneeded alert, **at the same severity class**: is a missed deterioration worse, equal, or less bad than an unneeded alert? By roughly what factor?
   Answer: **Worse**. Factor (best guess and range): **3× (2× to 5×)**
...
4. The lowest class at which you would say "an error of this class or worse must be caught by a clinician before it reaches the patient, and an unreviewed error is not acceptable":
   Class 1 / **Class 2** / Class 3 (circle one). Reason, if you wish: **Class 2 errors can cause clinically meaningful delay or unnecessary intervention and should not reach the patient without human review.**
...
5. What is the **smallest sustained relative rise** that would make you want someone to look into it?
   Circle one: **25 percent** / 50 percent / 100 percent / other: ______
...
7. What rise would make you want to **suspend the tool** pending review? **100 percent**
8. How long would the rise have to persist before you would act on it (days or weeks)? **2 weeks**
...
10. Roughly how many patients per week would such a tool score in the setting you have in mind (your ward, your hospital, or a typical mid-size hospital)? **500 patients per week**
11. Anything in the classes, the two error types, or the setting that seems unrealistic for your practice? **The basic framing is realistic. In practice, the clinical impact of an alert also depends on alert volume, timing, staffing, and whether the alert is actionable.**
...
Answered by: **Yunguo Yu, MD, PhD**  Role: **Physician / AI healthcare researcher**  Date: **September 20, 2026**

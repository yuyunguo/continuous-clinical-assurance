...
[DRAFT PENDING -- next section per the project's writing-order convention.]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\authorcontributions{[TO BE COMPLETED per CRediT taxonomy once all authors are confirmed.]}
...
\conflictsofinterest{[TO BE COMPLETED.]}
